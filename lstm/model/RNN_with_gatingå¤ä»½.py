...
class RNN(object):
    ...
    def build_train(self, X_train, Y_train, X_test = None, Y_test = None):
        ...
        self.compute_train_error = theano.function(inputs = [index, ],
        ...
        self.train_model = theano.function(inputs = [index, lr, mom],
                                      outputs = cost,
                                      updates = updates,
                                      givens = {
    ...
    def train(self):
        ...
        while (epoch < self.n_epochs):
            ...
            for idx in xrange(n_train):
                ...
                example_cost = self.train_model(idx,
                                           self.learning_rate,
                                           effective_momentum)
            '''if epoch%300==0:
            ...
            train_losses = [self.compute_train_error(i)
